...
- 每位學生一行：學生 ｜ 導師 ｜ $/LSN ｜ 堂數 ｜ 出席／請假／缺席 ｜ 應收 ｜ ☐已發送（旁有 WhatsApp／複製）｜ ☐已繳 ｜ 付款方式▾ ｜ 付款日期 ｜ ☐收據 ｜ 學費單預覽。
...
- **A. 學費卡片走完整個流程**（878f621）：已發送卡片折疊式繳費小表單（當時另有「核對」勾選，2026-09-23 按用戶要求移除——人工複核沒有實際用途）（已繳／實收／方式／日期／收據，未繳清預設展開、已繳清收起→「修改繳費」）；已發送欄標題「N 筆學費未繳清」；「類別」多「學費 · 未繳清／已繳清」。資料仍是同一條 `TUITION` 條目，繳費表不變。
